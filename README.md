...
A Chrome-Dino-inspired endless runner built **entirely with MakeCode Arcade blocks** (`main.blocks` — no hand-written code). Open this repository with MakeCode Arcade via **Import Project → Import URL**, **Play it: https://arcade.makecode.com/S19930-69478-68899-92354**
